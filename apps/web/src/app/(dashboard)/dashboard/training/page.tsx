    ...
    <div>
      <div className="page-header">
        ...
        <button
          ...
          onClick={() => {
            log.info('CreateCourse', 'Opening course creation form');
            toast.info('Create Course', 'Course creation form is opening.');
          }}
        >
          <svg
            width="16"
      ...
      <div className="grid grid-cols-4" style={{ marginBottom: 'var(--space-6)' }}>
        <div className="stat-card">
          ...
          <div>
            <div className="stat-value">{mockCourses.length}</div>
        ...
        <div className="stat-card">
          ...
          <div>
            <div className="stat-value">{mockCourses.reduce((s, c) => s + c.enrolled, 0)}</div>
        ...
        <div className="stat-card">
          ...
          <div>
            <div className="stat-value">
              {(mockCourses.reduce((s, c) => s + c.rating, 0) / mockCourses.length).toFixed(1)}
            </div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-2)' }}>
                <div
                  style={{
                    ...
                    background: categoryColors[course.category] || 'var(--text-tertiary)',
                  }}
                />
                <span className="text-xs text-secondary">{course.category}</span>
              </div>
              <span className={`badge ${statusConfig[course.status]?.class}`}>
              ...
              <button
                ...
                onClick={() => {
                  if (course.enrolled < course.capacity) {
                    log.info('Enroll', `Enrolling in ${course.title}`);
                    toast.success('Enrolled!', `You have been enrolled in "${course.title}".`);
                  }
                }}
              >
