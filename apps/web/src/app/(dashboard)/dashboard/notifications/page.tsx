...
const mockNotifications: NotificationItem[] = [
  {
    ...
    message:
      'Sarah Johnson has requested 3 days annual leave (Mar 5-7). Please review and approve.',
    priority: 'high',
    isRead: false,
  ...
  },
  {
    ...
    message: 'David Kim arrived 45 minutes late today. This is the 3rd occurrence this month.',
    priority: 'normal',
    isRead: false,
    timestamp: '2026-02-23T04:15:00',
    sender: 'System',
  ...
  },
  {
    ...
    message: 'February 2026 payroll has been processed. 7 payslips generated totaling $48,470 net.',
    priority: 'normal',
    isRead: false,
  ...
  },
  {
    ...
    message:
      'Directory sync completed successfully. 42 users synchronized, 2 new users provisioned.',
    priority: 'low',
    isRead: true,
  ...
  },
  {
    ...
    message: 'Q1 2026 performance review cycle starts in 7 days. Ensure all goals are updated.',
    priority: 'high',
    isRead: true,
  ...
  },
  {
    ...
    message:
      'Updated Remote Work Policy v3 is now active. All employees must acknowledge by March 15.',
    priority: 'urgent',
    isRead: false,
  ...
  },
  {
    ...
    message: 'Your annual leave request for Feb 28 - Mar 1 has been approved by your manager.',
    priority: 'normal',
    isRead: true,
  ...
  },
  {
    ...
    message:
      'System maintenance window: Saturday Feb 25, 2:00 AM - 4:00 AM UTC. Brief downtime expected.',
    priority: 'low',
    isRead: true,
...
export default function NotificationsPage() {
  ...
  const markAllRead = () => {
    ...
    log.info('MarkAllRead', `Marked ${unreadCount} notifications as read`);
      ...
      <div className="page-header">
        ...
        <div style={{ display: 'flex', gap: 'var(--space-3)' }}>
          ...
          <button
            ...
            onClick={() => {
              log.info('Preferences', 'Opening notification preferences');
              toast.info('Preferences', 'Notification preferences panel opening.');
            }}
          >
            <svg
              width="16"
      ...
      >
        ...
        <div style={{ display: 'flex', gap: 'var(--space-1)' }}>
          ...
          {Object.entries(typeConfig).map(([key, cfg]) => (
            <button
              key={key}
              className={`btn btn-sm ${typeFilter === key ? 'btn-primary' : 'btn-secondary'}`}
        ...
        {filtered.map((notif) => (
          ...
          >
            <div
              ...
              style={{
                background: `${typeConfig[notif.type]?.color}20`,
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              >
                <span style={{ fontWeight: notif.isRead ? 400 : 600, fontSize: '0.875rem' }}>
                  {notif.title}
                </span>
                {notif.priority !== 'normal' && (
                  <span
                    className={`badge ${priorityConfig[notif.priority]?.class}`}
              ...
              <p
                ...
                style={{ lineHeight: 1.5, marginBottom: 'var(--space-1)' }}
              >
                {notif.message}
              </p>
              <div style={{ display: 'flex', gap: 'var(--space-3)' }}>
                {notif.sender && (
                  <span className="text-xs text-tertiary">From: {notif.sender}</span>
                )}
