...
const navItems = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Benefits', href: '/dashboard/benefits', icon: 'heart' },
    ],
  },
  {
    section: 'System',
...
const iconPaths: Record<string, string> = {
  ...
  wallet:
    'M21 12V7H5a2 2 0 0 1 0-4h14v4 M3 5v14a2 2 0 0 0 2 2h16v-5 M18 12a1 1 0 1 0 0 2 1 1 0 0 0 0-2z',
  briefcase:
  ...
  plug: 'M12 2v6 M6 6h12 M6 6v6a6 6 0 0 0 12 0V6 M12 18v4',
    ...
    <div className={styles['dashboard-layout']}>
      ...
      >
        ...
        <div className={styles['sidebar-footer']}>
          <button className={styles['sidebar-link']} onClick={() => logout()}>
            <svg
              width="20"
              height="20"
              viewBox="0 0 24 24"
      ...
      {/* Main */}
      <div
        className={`${styles['main-content']} ${sidebarCollapsed ? styles['sidebar-collapsed'] : ''}`}
      >
        {/* Topbar */}
        <header className={styles.topbar}>
          ...
          <div className={styles['topbar-right']}>
            ...
            <div className={styles['topbar-user']}>
              <div className={styles['topbar-avatar']}>{initials}</div>
              <div>
                <div className={styles['topbar-user-name']}>{displayName}</div>
                <div className={styles['topbar-user-role']}>{roleBadge}</div>
              </div>
            </div>
          </div>
        </header>
